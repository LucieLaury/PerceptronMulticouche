...
public class Ville extends Problem {
    ...
    private void calculerHeuristiqueGoalState(){
        System.out.println("Calcul des heuristiques pour tous les états");
    ...
    public void initAllActionTransition(){
        System.out.println("Création des actions/transition pour tous les états et calculs des coûts");
        VilleState stateCourant;
        String nomCourant;
        for(int i = 0; i<STATES.size(); i++){
           stateCourant = STATES.get(i);
